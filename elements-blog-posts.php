...
<!-- molla/elements-blog-posts.php  22 Nov 2019 10:05:18 GMT -->
<head>
    <meta charset="UTF-8">
                		...
                		<div class="col-md-6">
                			<article class="entry entry-grid">
                				...
                				<div class="entry-body text-center">
                					...
                					<h2 class="entry-title">
                						<a href="single.php">Aliquam tincidunt mauris.</a>
                					</h2><!-- End .entry-title -->
                		...
                		<div class="col-sm-6 col-md-4">
                			<article class="entry entry-grid">
                				...
                				<div class="entry-body text-center">
                					...
                					<h2 class="entry-title">
                						<a href="single.php">Nunc dignissim risus.</a>
                					</h2><!-- End .entry-title -->
                		...
                		<div class="col-sm-6 col-lg-3">
                			<article class="entry entry-grid">
                				...
                				<div class="entry-body text-center">
                					...
                					<div class="entry-content">
                						<p>Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero ...</p> <a href="single.php" class="read-more">Read More</a>
                					</div><!-- End .entry-content -->
                				</div><!-- End .entry-body -->
                			</article><!-- End .entry -->
                		</div><!-- End .col-lg-3 -->
...
<!-- molla/elements-blog-posts.php  22 Nov 2019 10:05:20 GMT -->
</html>