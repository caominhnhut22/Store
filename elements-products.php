...
<!-- molla/elements-products.php  22 Nov 2019 10:04:52 GMT -->
<head>
    <meta charset="UTF-8">
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="elements-list.php">Elements</a></li>
                ...
                <div class="container">
                		...
                		<div class="col-6 col-md-4 col-lg-4">
                			<div class="product text-center">
                				...
                				<div class="product-body">
                					...
                					<h3 class="product-title"><a href="product.php">Aliquam tincidunt mauris</a></h3><!-- End .product-title -->
                		...
                		<div class="col-6 col-md-4 col-lg-4">
                			<div class="product text-center">
                				...
                				<div class="product-body">
                					...
                					<h3 class="product-title"><a href="product.php">Vestibulum auctor</a></h3><!-- End .product-title -->
                					<div class="product-price">
                						$120.00
                					</div><!-- End .product-price -->
                                    <div class="product-size">
                		...
                		<div class="col-6 col-md-4 product-1 col-lg-4">
                			<div class="product text-center">
                				...
                				<div class="product-body">
                					...
                					<h3 class="product-title"><a href="product.php">Nunc dignissim risus</a></h3><!-- End .product-title -->
                					<div class="product-price">
                    ...
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
            			...
            			<div class="product">
            				...
            				<div class="product-body product-action-inner">
            					...
            					<h3 class="product-title"><a href="product.php">Cras ornare tristique</a></h3><!-- End .product-title -->
            					<div class="product-price">
            						<span class="out-price">$32.00</span>
            					</div><!-- End .product-price -->
            					<div class="ratings-container">
                    ...
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow product-4-carousel" data-toggle="owl" 
                        ...
                        <div class="product product-4 text-center">
                            ...
                            <div class="product-body">
                                <h3 class="product-title"><a href="product.php">Aliquam tincidunt</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $299.00
                                </div><!-- End .product-price -->
                            </div><!-- End .product-body -->
                        ...
                        <div class="product product-4 text-center">
                            ...
                            <div class="product-body">
                                <h3 class="product-title"><a href="product.php">Vivamus vestibulum</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $110.00
                                </div><!-- End .product-price -->
                                <div class="product-nav product-nav-dots">
                    ...
                    <div class="row">
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                            <div class="product product-5 text-center">
                                ...
                                <div class="product-body">
                                    <h3 class="product-title"><a href="product.php">Brown cable knit cardigan</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        <span class="new-price">$50.00</span>
                                        <span class="old-price">$84.00</span>
                                    </div><!-- End .product-price -->
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                            <div class="product product-5 text-center">
                                ...
                                <div class="product-body">
                                    <h3 class="product-title"><a href="product.php">Hooded parka jacket</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $120.00
                                    </div><!-- End .product-price -->
                                </div><!-- End .product-body -->
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                            <div class="product product-5 text-center">
                                ...
                                <div class="product-body">
                                    <h3 class="product-title"><a href="product.php">Grey cable knit longline maxi  cardigan</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $110.00
                                    </div><!-- End .product-price -->
                                </div><!-- End .product-body -->
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                            <div class="product product-5 product-disabled text-center">
                                ...
                                <div class="product-body">
                                    <h3 class="product-title"><a href="product.php">Orange snake print scarf</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                            <div class="product product-5 text-center">
                                ...
                                <div class="product-body">
                                    <h3 class="product-title"><a href="product.php">Beige knitted elastic runner shoes</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $84.00
                                    </div><!-- End .product-price -->
                                </div><!-- End .product-body -->
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                            <div class="product product-5 text-center">
                                ...
                                <div class="product-body">
                                    <h3 class="product-title"><a href="product.php">Grey check skinny suit jacket</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $180.00
                                    </div><!-- End .product-price -->
                                </div><!-- End .product-body -->
            ...
            <div class="container mb-5">
                <div class="row elements">
                    <div class="col-xl-5col col-lg-4 col-md-3 col-6">
                        <a href="elements-accordions.php" class="element-type">
                            <div class="element">
                    ...
                    <div class="col-xl-5col col-lg-4 col-md-3 col-6">
                        <a href="elements-banners.php" class="element-type">
                            <div class="element">
                                <i class="element-img"></i>
                                <i class="element-hover-img"></i>
                                <p>banners</p>
                    ...
                    <div class="col-xl-5col col-lg-4 col-md-3 col-6">
                        <a href="elements-blog-posts.php" class="element-type">
                            <div class="element">
                                <i class="element-img"></i>
                                <i class="element-hover-img"></i>
                                <p>blog posts</p>
                    ...
                    <div class="col-xl-5col col-lg-4 col-md-3 col-6">
                        <a href="elements-buttons.php" class="element-type">
                            <div class="element">
                                <i class="element-img"></i>
                                <i class="element-hover-img"></i>
                                <p>buttons</p>
                    ...
                    <div class="col-xl-5col col-lg-4 col-md-3 col-6">
                        <a href="elements-cta.php" class="element-type">
                            <div class="element">
                                <i class="element-img"></i>
                                <i class="element-hover-img"></i>
                                <p>call to action</p>
                    ...
                    <div class="col-xl-5col col-lg-4 col-md-3 col-6">
                        <a href="elements-icon-boxes.php" class="element-type">
                            <div class="element">
                                <i class="element-img"></i>
                                <i class="element-hover-img"></i>
                                <p>icon boxes</p>
                    ...
                    <div class="col-xl-5col col-lg-4 col-md-3 col-6">
                        <a href="elements-portfolio.php" class="element-type">
                            <div class="element">
                                <i class="element-img"></i>
                                <i class="element-hover-img"></i>
                                <p>portfolio</p>
                    ...
                    <div class="col-xl-5col col-lg-4 col-md-3 col-6">
                        <a href="elements-product-category.php" class="element-type">
                            <div class="element">
                                <i class="element-img"></i>
                                <i class="element-hover-img"></i>
                    ...
                    <div class="col-xl-5col col-lg-4 col-md-3 col-6">
                        <a href="elements-products.php" class="element-type">
                            <div class="element">
                                <i class="element-img"></i>
                                <i class="element-hover-img"></i>
                                <p>products</p>
                    ...
                    <div class="col-xl-5col col-lg-4 col-md-3 col-6">
                        <a href="elements-tabs.php" class="element-type">
                            <div class="element">
                                <i class="element-img"></i>
                                <i class="element-hover-img"></i>
                                <p>tabs</p>
                    ...
                    <div class="col-xl-5col col-lg-4 col-md-3 col-6">
                        <a href="elements-testimonials.php" class="element-type">
                            <div class="element">
                                <i class="element-img"></i>
                                <i class="element-hover-img"></i>
                                <p>testimonials</p>
                    ...
                    <div class="col-xl-5col col-lg-4 col-md-3 col-6">
                        <a href="elements-titles.php" class="element-type">
                            <div class="element">
                                <i class="element-img"></i>
                                <i class="element-hover-img"></i>
                                <p>titles</p>
                    ...
                    <div class="col-xl-5col col-lg-4 col-md-3 col-6">
                        <a href="elements-typography.php" class="element-type">
                            <div class="element">
                                <i class="element-img"></i>
                                <i class="element-hover-img"></i>
                                <p>typography</p>
                    ...
                    <div class="col-xl-5col col-lg-4 col-md-3 col-6">
                        <a href="elements-video-banners.php" class="element-type">
                            <div class="element">
                                <i class="element-img"></i>
                                <i class="element-hover-img"></i>
                                <p>video</p>
...
<!-- molla/elements-products.php  22 Nov 2019 10:05:00 GMT -->
</html>